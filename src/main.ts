...
import { Stunts } from './game/Stunts';
...
const systems: System[] = [
  pipeline, input, sky, materials, track, scenery, race, items, stunts, effects, camera, hud,
  audio, drawBudget,
];
...
const SYSTEM_LABELS = [
  ...
  'planting stunt zones', 'lighting the effects', 'mounting the camera', 'drawing the hud',
...
// The HUD instance — lets a probe assert which DOM root the live HUD actually
// owns, which is how the duplicate-module HMR bug was pinned down.
(window as any).__hud = hud;
