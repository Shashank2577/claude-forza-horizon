...
function torsoAndLegs(): Built {
  ...
  // ROADSTER CONVERSION: slimmed ~18% across the shoulders. In the kart's tall
  // open tub the wide suit back read as a slab seat; in a low speedster
  // cockpit a narrower chest reads as a driver wearing a race suit.
  const body: Section[] = [
    { z: 0.00, hw: 0.170, hh: 0.130, r: 0.07 },
    { z: 0.14, hw: 0.188, hh: 0.138, r: 0.075 },
    { z: 0.30, hw: 0.205, hh: 0.145, r: 0.08 },
    { z: 0.41, hw: 0.216, hh: 0.140, r: 0.082 },
    { z: 0.47, hw: 0.180, hh: 0.122, r: 0.08 },
  ];
